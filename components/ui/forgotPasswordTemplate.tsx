...
export default function forgotPasswordTemplate({ name, otp }: Props) {
  return `
    <div>
        <p>Dear, ${name}</p>
        ...
        <p>This otp is valid for 1 hour only. Enter this otp in the FundaMentalEureka website to proceed with resetting your password.</p>
        <br/>
        </br>
        <p>Thanks</p>
